...
from empleo_desarrolladores.views import OfferList, OfferCreate, OfferDelete, OfferUpdate, Home, OfferDetailsView
...
urlpatterns = patterns('',
    ...
    url(r'offer/(?P<pk>\d+)/update$', OfferUpdate.as_view(), name='offer_update'),
    url(r'offer/(?P<pk>\d+)/$', OfferDetailsView.as_view(), name='offer_detail'),
