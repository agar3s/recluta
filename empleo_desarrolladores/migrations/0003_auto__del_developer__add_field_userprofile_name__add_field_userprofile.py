...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'empleo_desarrolladores_userprofile', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.mail'
        db.add_column(u'empleo_desarrolladores_userprofile', 'mail',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.password'
        db.add_column(u'empleo_desarrolladores_userprofile', 'password',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'empleo_desarrolladores_userprofile', 'name')

        # Deleting field 'UserProfile.mail'
        db.delete_column(u'empleo_desarrolladores_userprofile', 'mail')

        # Deleting field 'UserProfile.password'
        db.delete_column(u'empleo_desarrolladores_userprofile', 'password')
