...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.state'
        db.add_column(u'empleo_desarrolladores_offer', 'state',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.state'
        db.delete_column(u'empleo_desarrolladores_offer', 'state')
