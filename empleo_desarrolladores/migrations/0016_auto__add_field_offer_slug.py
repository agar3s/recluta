...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'empleo_desarrolladores_offer', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='jkfjkfd', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.slug'
        db.delete_column(u'empleo_desarrolladores_offer', 'slug')
