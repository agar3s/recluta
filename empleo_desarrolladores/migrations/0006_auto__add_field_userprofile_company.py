...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'empleo_desarrolladores_userprofile', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empleo_desarrolladores.Company'], null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field offers on 'Company'
        m2m_table_name = db.shorten_name(u'empleo_desarrolladores_company_offers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('company', models.ForeignKey(orm[u'empleo_desarrolladores.company'], null=False)),
            ('offer', models.ForeignKey(orm[u'empleo_desarrolladores.offer'], null=False))
        ))
        db.create_unique(m2m_table_name, ['company_id', 'offer_id'])


    def backwards(self, orm):
        # Deleting field 'UserProfile.company'
        db.delete_column(u'empleo_desarrolladores_userprofile', 'company_id')

        # Removing M2M table for field offers on 'Company'
        db.delete_table(db.shorten_name(u'empleo_desarrolladores_company_offers'))
