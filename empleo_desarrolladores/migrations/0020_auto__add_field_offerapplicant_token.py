...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfferApplicant.token'
        db.add_column(u'empleo_desarrolladores_offerapplicant', 'token',
                      self.gf('django.db.models.fields.TextField')(default='fdfswefdsaffefdsaf', unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfferApplicant.token'
        db.delete_column(u'empleo_desarrolladores_offerapplicant', 'token')
