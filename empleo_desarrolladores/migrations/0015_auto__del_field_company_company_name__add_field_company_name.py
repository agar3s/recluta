...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'empleo_desarrolladores_company', 'company_name')

        # Adding field 'Company.name'
        db.add_column(u'empleo_desarrolladores_company', 'name',
                      self.gf('django.db.models.fields.CharField')(default='codetag', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Company.company_name'
        db.add_column(u'empleo_desarrolladores_company', 'company_name',
                      self.gf('django.db.models.fields.CharField')(default='codetag', max_length=100),
                      keep_default=False)

        # Deleting field 'Company.name'
        db.delete_column(u'empleo_desarrolladores_company', 'name')
