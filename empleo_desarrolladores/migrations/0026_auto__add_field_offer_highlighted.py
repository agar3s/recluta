...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.highlighted'
        db.add_column(u'empleo_desarrolladores_offer', 'highlighted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.highlighted'
        db.delete_column(u'empleo_desarrolladores_offer', 'highlighted')
