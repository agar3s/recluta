...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'empleo_desarrolladores_company', 'phone', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'Company.phone'
        db.alter_column(u'empleo_desarrolladores_company', 'phone', self.gf('django.db.models.fields.IntegerField')(max_length=100))
