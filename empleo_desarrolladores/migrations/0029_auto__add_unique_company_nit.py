...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Company', fields ['nit']
        db.create_unique(u'empleo_desarrolladores_company', ['nit'])


    def backwards(self, orm):
        # Removing unique constraint on 'Company', fields ['nit']
        db.delete_unique(u'empleo_desarrolladores_company', ['nit'])
