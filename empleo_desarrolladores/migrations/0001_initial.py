...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'empleo_desarrolladores_developer', (
        ...
        db.send_create_signal(u'empleo_desarrolladores', ['Developer'])

        # Adding model 'Offer'
        db.create_table(u'empleo_desarrolladores_offer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('offer_company_that_publishes', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('job_title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('type_contract', self.gf('django.db.models.fields.CharField')(default='TF', max_length=2)),
            ('salary', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2)),
            ('offer_valid_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('mandatory_skills', self.gf('django.db.models.fields.TextField')()),
            ('optional_skills', self.gf('django.db.models.fields.TextField')()),
            ('job_description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'empleo_desarrolladores', ['Offer'])

        # Adding model 'Company'
        db.create_table(u'empleo_desarrolladores_company', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nit', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ...
            ('phone', self.gf('django.db.models.fields.IntegerField')(max_length=100)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'empleo_desarrolladores', ['Company'])

        # Adding model 'UserProfile'
        db.create_table(u'empleo_desarrolladores_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('biography', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'empleo_desarrolladores', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'Developer'
        db.delete_table(u'empleo_desarrolladores_developer')

        # Deleting model 'Offer'
        db.delete_table(u'empleo_desarrolladores_offer')

        # Deleting model 'Company'
        db.delete_table(u'empleo_desarrolladores_company')

        # Deleting model 'UserProfile'
        db.delete_table(u'empleo_desarrolladores_userprofile')
    ...
    models = {
        ...
        u'empleo_desarrolladores.developer': {
        ...
        u'empleo_desarrolladores.offer': {
            ...
            'offer_company_that_publishes': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
