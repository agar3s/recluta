...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Offer', fields ['slug']
        db.create_unique(u'empleo_desarrolladores_offer', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Offer', fields ['slug']
        db.delete_unique(u'empleo_desarrolladores_offer', ['slug'])
