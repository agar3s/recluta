...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.slug'
        db.alter_column(u'empleo_desarrolladores_offer', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=250))

    def backwards(self, orm):

        # Changing field 'Offer.slug'
        db.alter_column(u'empleo_desarrolladores_offer', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100, unique=True))
