...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Offer.company'
        db.add_column(u'empleo_desarrolladores_offer', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empleo_desarrolladores.Company'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Offer.company'
        db.delete_column(u'empleo_desarrolladores_offer', 'company_id')
