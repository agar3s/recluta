...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OfferApplicant'
        db.create_table(u'empleo_desarrolladores_offerapplicant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('offer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empleo_desarrolladores.Offer'])),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empleo_desarrolladores.Applicant'])),
            ('observation', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'empleo_desarrolladores', ['OfferApplicant'])

        # Deleting field 'Applicant.observation'
        db.delete_column(u'empleo_desarrolladores_applicant', 'observation')

        # Removing M2M table for field applicants on 'Offer'
        db.delete_table(db.shorten_name(u'empleo_desarrolladores_offer_applicants'))


    def backwards(self, orm):
        # Deleting model 'OfferApplicant'
        db.delete_table(u'empleo_desarrolladores_offerapplicant')

        # Adding field 'Applicant.observation'
        db.add_column(u'empleo_desarrolladores_applicant', 'observation',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding M2M table for field applicants on 'Offer'
        m2m_table_name = db.shorten_name(u'empleo_desarrolladores_offer_applicants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('offer', models.ForeignKey(orm[u'empleo_desarrolladores.offer'], null=False)),
            ('applicant', models.ForeignKey(orm[u'empleo_desarrolladores.applicant'], null=False))
        ))
        db.create_unique(m2m_table_name, ['offer_id', 'applicant_id'])
