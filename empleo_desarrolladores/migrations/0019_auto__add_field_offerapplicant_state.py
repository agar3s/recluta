...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfferApplicant.state'
        db.add_column(u'empleo_desarrolladores_offerapplicant', 'state',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfferApplicant.state'
        db.delete_column(u'empleo_desarrolladores_offerapplicant', 'state')
