...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfferApplicant.resume'
        db.add_column(u'empleo_desarrolladores_offerapplicant', 'resume',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfferApplicant.resume'
        db.delete_column(u'empleo_desarrolladores_offerapplicant', 'resume')
