...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'empleo_desarrolladores_offer', 'location',
                      self.gf('django.db.models.fields.CharField')(default='Bogota', max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.location'
        db.delete_column(u'empleo_desarrolladores_offer', 'location')
