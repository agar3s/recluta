...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Card'
        db.delete_table(u'empleo_desarrolladores_card')

        # Deleting field 'UserProfile.card'
        db.delete_column(u'empleo_desarrolladores_userprofile', 'card_id')


    def backwards(self, orm):
        # Adding model 'Card'
        db.create_table(u'empleo_desarrolladores_card', (
            ...
            ('ccv2', self.gf('django.db.models.fields.IntegerField')(max_length=15)),
            ('postal_code', self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('owner', self.gf('django.db.models.fields.CharField')(max_length=50)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('card_type', self.gf('django.db.models.fields.CharField')(default='VS', max_length=2)),
            ('expiration', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'empleo_desarrolladores', ['Card'])

        # Adding field 'UserProfile.card'
        db.add_column(u'empleo_desarrolladores_userprofile', 'card',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['empleo_desarrolladores.Card'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'empleo_desarrolladores.offer': {
            ...
            'clarification': ('django.db.models.fields.TextField', [], {'null': 'True'}),
