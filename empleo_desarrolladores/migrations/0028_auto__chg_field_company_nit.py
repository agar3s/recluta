...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.nit'
        db.alter_column(u'empleo_desarrolladores_company', 'nit', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Company.nit'
        db.alter_column(u'empleo_desarrolladores_company', 'nit', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
    ...
    models = {
        ...
        u'empleo_desarrolladores.company': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'nit': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
