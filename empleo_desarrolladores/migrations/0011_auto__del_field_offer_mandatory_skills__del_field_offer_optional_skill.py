...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Offer.mandatory_skills'
        db.delete_column(u'empleo_desarrolladores_offer', 'mandatory_skills')

        # Deleting field 'Offer.optional_skills'
        db.delete_column(u'empleo_desarrolladores_offer', 'optional_skills')

        # Adding field 'Offer.skills'
        db.add_column(u'empleo_desarrolladores_offer', 'skills',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Offer.mandatory_skills'
        db.add_column(u'empleo_desarrolladores_offer', 'mandatory_skills',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Offer.optional_skills'
        db.add_column(u'empleo_desarrolladores_offer', 'optional_skills',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'Offer.skills'
        db.delete_column(u'empleo_desarrolladores_offer', 'skills')
