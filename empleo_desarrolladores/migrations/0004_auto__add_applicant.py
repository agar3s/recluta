...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'empleo_desarrolladores_applicant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('mail', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75)),
            ('observation', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'empleo_desarrolladores', ['Applicant'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'empleo_desarrolladores_applicant')
    ...
    models = {
        ...
        u'empleo_desarrolladores.applicant': {
            ...
            'observation': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        ...
        u'empleo_desarrolladores.offer': {
            ...
            'applicants': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['empleo_desarrolladores.Applicant']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
