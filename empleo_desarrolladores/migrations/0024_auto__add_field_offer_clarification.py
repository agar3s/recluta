...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.clarification'
        db.add_column(u'empleo_desarrolladores_offer', 'clarification',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.clarification'
        db.delete_column(u'empleo_desarrolladores_offer', 'clarification')
